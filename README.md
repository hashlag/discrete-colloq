...
1. Способы задания множеств (5)
    ...
    - **Характеристика** (описание): $A = \{x: x \in R\}$
    - **Порождающая процедура:** $x = \pi + 2\piК; K \in Z$
...
1. Подмножество и отличие собственных и несобственных подмножеств
    ...
    - **Собственные** подмножества — **само множество** и **пустое множество**
    - Несобственные подмножества — все остальные подмножества $C$, так, что $С \subset А$
2. Булеан множества
